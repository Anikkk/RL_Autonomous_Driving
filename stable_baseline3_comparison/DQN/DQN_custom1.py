...
from custom_reward3 import custom_reward_function
...
RENDER_FREQ = 80_000
ALGO = "DQN_custom1"
VIDEO_DIR = f"{ALGO}_training_videos"
...
def train():
    ...
    train_env.reward_function = lambda vehicle_id: custom_reward_function(train_env, vehicle_id)
    obs, _ = train_env.reset()

    model = DQN("MlpPolicy", train_env, verbose=1, tensorboard_log="logs/", seed=SEED)
